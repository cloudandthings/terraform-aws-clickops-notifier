...
| <a name="input_lambda_runtime"></a> [lambda\_runtime](#input\_lambda\_runtime) | The lambda runtime to use. One of: `["python3.10", "python3.11", "python3.12", "python3.13"]`. Note: python3.8 and python3.9 are deprecated and no longer supported by AWS Lambda. | `string` | `"python3.13"` | no |
